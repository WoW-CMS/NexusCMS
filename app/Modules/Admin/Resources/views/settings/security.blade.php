...
<div class="bg-white rounded-lg shadow">
    <div class="p-6 border-b border-gray-200">
        ...
        <p class="text-sm text-gray-600 mt-1">Configure authentication, password policies y protección de cuentas</p>
    </div>
    <div class="p-6 space-y-8">
        <div>
            <h3 class="text-lg font-medium text-gray-900 mb-4 border-b pb-2">Password Policy</h3>
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Minimum Password Length</label>
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-2">
                        ...
                        <label for="password_uppercase" class="text-sm text-gray-700">Require Uppercase Letters</label>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <label for="password_numbers" class="text-sm text-gray-700">Require Numbers</label>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <label for="password_special" class="text-sm text-gray-700">Require Special Characters</label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <h3 class="text-lg font-medium text-gray-900 mb-4 border-b pb-2">Account Protection</h3>
            <div class="grid md:grid-cols-2 gap-4">
                <div>
        ...
        <div>
            <h3 class="text-lg font-medium text-gray-900 mb-4 border-b pb-2">Session and Authentication</h3>
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-2">
                        ...
                        <label for="force_https" class="text-sm text-gray-700">Force HTTPS</label>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <label for="enable_2fa" class="text-sm text-gray-700">Enable 2FA</label>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <label for="require_email_verification" class="text-sm text-gray-700">Require Email Verification</label>
                    </div>
                </div>
            </div>
        </div>
