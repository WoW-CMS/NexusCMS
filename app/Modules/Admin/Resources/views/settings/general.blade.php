...
<div class="bg-white rounded-lg shadow">
    ...
    <div class="p-6 space-y-4">
        ...
        <div>
            ...
            <textarea name="site_description" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ $settings['site_description'] ?? 'The ultimate World of Warcraft private server experience with custom content and balanced gameplay.' }}</textarea>
        </div>
        <div class="grid md:grid-cols-2 gap-4">
            <div>
