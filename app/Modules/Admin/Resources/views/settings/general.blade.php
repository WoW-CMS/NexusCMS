...
<div class="bg-white rounded-lg shadow">
    <div class="p-6 border-b border-gray-200">
        <h2 class="text-xl font-bold text-gray-800">{{ __('admin::settings.general.title') }}</h2>
        <p class="text-sm text-gray-600 mt-1">{{ __('admin::settings.general.description') }}</p>
    </div>
    <div class="p-6 space-y-4">
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('admin::settings.general.site_name') }}</label>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('admin::settings.general.site_url') }}</label>
        ...
        <div>
            <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('admin::settings.general.site_description') }}</label>
        ...
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('admin::settings.general.admin_email') }}</label>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('admin::settings.localization.timezone.label') }}</label>
        ...
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('admin::settings.localization.date_format.label') }}</label>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('admin::settings.localization.time_format.label') }}</label>
        ...
        <div class="flex items-center gap-2">
            ...
            <label for="registration" class="text-sm text-gray-700">{{ __('admin::settings.general.allow_registration') }}</label>
        </div>
    </div>
</div>
@endsection
