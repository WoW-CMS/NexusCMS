...
<div class="bg-white rounded-lg shadow">
    <div class="p-6 border-b border-gray-200">
        <h2 class="text-xl font-bold text-gray-800">{{ __('admin::settings.email.title') }}</h2> 
        <p class="text-sm text-gray-600 mt-1">{{ __('admin::settings.email.description') }}</p> 
    </div>
    <div class="p-6 space-y-4">
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('admin::settings.email.smtp_host.label') }}</label>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('admin::settings.email.smtp_port.label') }}</label>
                <input type="number" name="smtp_port" value="{{ $settings['smtp_port'] ?? '589' }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
        </div>
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('admin::settings.email.smtp_username') }}</label>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('admin::settings.email.smtp_password') }}</label>
        ...
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('admin::settings.email.smtp_encryption') }}</label>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">{{ __('admin::settings.email.mail_from_name') }}</label>
        ...
        <div>
            <button type="button" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 font-medium">
                <i class="fas fa-paper-plane mr-2"></i>{{ __('admin::settings.email.send_test') }}
            </button>
        </div>
    </div>
</div>
