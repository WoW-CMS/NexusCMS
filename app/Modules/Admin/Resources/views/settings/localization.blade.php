...
<div class="bg-white rounded-lg shadow">
    <div class="p-6 border-b border-gray-200">
        <h2 class="text-xl font-bold text-gray-800">{{ __('Localization Settings') }}</h2>
        <p class="text-sm text-gray-600 mt-1">{{ __('Configure language, time, and currency preferences') }}</p>
    </div>
    <div class="p-6 space-y-4">
        <div class="grid md:grid-cols-2 gap-4">
            <div>
                <label for="default_locale" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('Default Locale') }}</label>
                ...
                <p class="mt-1 text-xs text-gray-500">{{ __('The default language for the application.') }}</p>
            </div>

            <div>
                <label for="timezone" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('Timezone') }}</label>
                ...
                <p class="mt-1 text-xs text-gray-500">{{ __('System-wide timezone setting.') }}</p> 
            </div>
        </div>

        <div class="grid md:grid-cols-2 gap-4">
            <div>
                <label for="date_format" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('Date Format') }}</label>
                ...
                <p class="mt-1 text-xs text-gray-500">{{ __('Display format for dates.') }}</p>
            </div>

            <div>
                <label for="time_format" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('Time Format') }}</label>
                ...
                <p class="mt-1 text-xs text-gray-500">{{ __('Display format for times.') }}</p>
            </div>
        </div>
    </div>
</div>
