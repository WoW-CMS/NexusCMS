            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-0.5">Update the details for this user account</p>
                    </div>
                </div>
        ...
        <form method="POST" action="{{ route('admin.users.update', $user) }}">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
                        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
                            <h2 class="text-base font-semibold text-gray-900">User Points</h2>
                            <p class="text-xs text-gray-500 mt-1">Update the current balance for the user</p>
                        </div>
                        <div class="p-6">
