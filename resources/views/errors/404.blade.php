        ...
        <div class="flex justify-center">
            <div class="w-full max-w-2xl">
                <div class="text-center">
                    <svg class="text-yellow-500 w-24 h-24 mx-auto mb-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <h1 class="text-6xl font-extrabold text-yellow-500 mb-4">404</h1>
                    <h2 class="text-2xl font-bold text-white mb-6">Page Not Found</h2>
                    <div class="bg-gray-800 rounded-lg shadow-lg p-8">
                        <p class="text-xl text-gray-300 mb-6">{{ $message ?? 'The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.' }}</p>
                        <hr class="border-gray-700 my-6">
                        <div class="text-gray-400 mb-8">
                            <p class="mb-3">Please check the URL in your address bar and try again.</p>
